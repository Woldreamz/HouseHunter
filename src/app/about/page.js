    ...
    return(
        <>
         ...
         <div class="aboutcontainer"> 
            <img class="img-1" src="images/handshake.png" alt=""/> 
           <div class="flex-div">
          ...
          <div class="aboutcontainer">
            ...
            <img class="img-1" src="images/handsup.png" alt=""/>
          ...
          <div class={styles.container3}>
            ...
            <div className={styles.teamInfo}>
              <div className={styles.info}>
                <img src="images/unsplash13.png" alt="" height="200px" max-width="200px"/>
                <p className={styles.p1}>Merit</p>
                <p className={styles.p2}>Product Manager</p>
              </div>

              <div className={styles.info}>
                <img src="images/unsplash12.png" alt="" height="200px" max-width="200px"/>
                <p className={styles.p1}>Rainer</p>
                <p className={styles.p2}>Web Design</p>
              </div>

              <div className={styles.info}>
                <img src="images/unsplash10.png" alt="" height="200px" max-width="200px"/>
                <p className={styles.p1}>Omah</p>
                <p className={styles.p2}>Product Manager</p>
              </div>

              <div className={styles.info}>
                <img src="images/unsplash11.png" alt="" height="200px" max-width="200px"/>
