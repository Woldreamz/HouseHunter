    ...
    return (
        <div className={styles.form1}>
            <div>
              ...
              <input class="form-control file" style={{width: "20%"}} type="file" name="id"/>
            </div>
            ...
            <div>
              ...
              <input class="form-control file" style={{width: "20%"}} type="file" name="certificate"/>
            </div>
            ...
            <div>
             ...
             <input class="form-control file" style={{width: "20%"}} type="file" name="land-docs" />
            </div>

            <div>
             <label htmlFor="otherdocs">Other utility receipts</label>
             <Input type="text" id="otherdocs" className="property-input" name="otherdocs" />
             <input class="form-control file" style={{width: "20%"}} type="file" name="docs"/>
            </div>
